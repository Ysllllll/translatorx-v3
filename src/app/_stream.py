...
from runtime.orchestrator import StreamingOrchestrator
from runtime.processors.translate import TranslateProcessor
from runtime.protocol import Priority, VideoKey
...
class StreamBuilder:
    ...
    def translate(
        self, *, tgt: str | tuple[str, ...], src: str | None = None, engine: str = "default"
    ) -> StreamBuilder:
