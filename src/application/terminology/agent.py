"""LLM-backed terminology / summary metadata extraction agent.

:class:`TermsAgent` calls an :class:`LLMEngine` to extract domain
terminology and summary metadata (topic / title / description) from a
block of source text.  It is the LLM bridge consumed by
:class:`application.terminology.providers.PreloadableTerms` and
:class:`application.terminology.providers.OneShotTerms`.
"""
