...
from lang_ops._core._chars import is_cjk_ideograph, is_hangul, is_hiragana, is_katakana
from lang_ops._core._normalize import normalize_language
...
def detect_language(text: str) -> str:
    ...
    """
    from preprocess._availability import langdetect_is_available
