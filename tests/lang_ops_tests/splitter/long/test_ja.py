"""Japanese (ja) long-text splitting tests."""
...
class TestLongTextJapanese(LongTextTestBase):
    LANGUAGE = "ja"
    ...
    def test_split_clauses(self) -> None:
        ...
        '日本の伝統文化と現代テクノロジーは、',
        '一見すると相反するもののように思える。しかし実際には、',
        '両者は深い関係にあり、',
        '多くの場面で融合が進んでいる。例えば京都の古い寺院では、',
        'AIを活用した観光ガイドが導入されている；',
        'また、',
        '書道の世界でもデジタルペンを使った新しい表現方法が注目を集めている。ある書道家は次のように語った。「技術は人間の感性を拡張するものである！」この言葉は、',
        '多くのクリエイターの共感を呼んだ……伝統工芸の分野でも、',
        '3Dプリンターを活用した新しい技法が開発されつつある。果たしてテクノロジーは伝統を破壊するのか、',
        'それとも新たな可能性を切り開くのか？専門家の意見は大きく分かれている。ある人類学者は「デジタルとアナログの融合は避けられない」と主張している！他方で、',
        'ある伝統工芸の職人は「手仕事の温もりは機械には出せない」と強く訴えている。しかし両者の対話を通じて、',
        '予想もしなかった革新的な作品が生まれることもある。例えば和紙とLED技術を融合した照明器具は、',
        '国内外で非常に高い評価を得ている。伝統を守りながら革新を取り入れる、',
