from domain.lang import LangOps, mecab_is_available
...
class JapaneseTextTest(LangOpsTestCase):
    ...
    def test_japanese(self) -> None:
        ...
        expected_character_tokens = [*"米|軍|司|令|官|“1|万|か|所|超|え|る|標|的|を|攻|撃”|司|令|官|は|25|日、|作|戦|の|進|捗|（し|ん|ち|ょ|く）|を|説|明|ク|・|タ|こ|ん|に|ち|は、|世|界！|AIengine|今|日|は|AI|字|幕|エ|ン|ジ|ン|日|本|語|English|Subtitle|自|動|整|列|し|ま|す。".split("|")]
        expected_character_tokens_without_punctuation = [*"米|軍|司|令|官|“|1|万|か|所|超|え|る|標|的|を|攻|撃|”|司|令|官|は|25|日|、|作|戦|の|進|捗|（|し|ん|ち|ょ|く|）|を|説|明|ク|・|タ|こ|ん|に|ち|は|、|世|界|！|AIengine|今|日|は|AI|字|幕|エ|ン|ジ|ン|日|本|語|English|Subtitle|自|動|整|列|し|ま|す|。".split("|")]
        mecab_word_tokens = [*"米軍|司令|官|“1|万|か所|超える|標的|を|攻撃”|司令|官|は|25|日、|作戦|の|進捗|（しん|ちょく）|を|説明|ク|・|タ|こんにちは、|世界！|AIengine|今日|は|AI|字幕|エンジン|日本|語|English|Subtitle|自動|整列|し|ます。".split("|")]
        mecab_word_tokens_without_punctuation = [*"米軍|司令|官|“|1|万|か所|超える|標的|を|攻撃|”|司令|官|は|25|日|、|作戦|の|進捗|（|しん|ちょく|）|を|説明|ク|・|タ|こんにちは|、|世界|！|AIengine|今日|は|AI|字幕|エンジン|日本|語|English|Subtitle|自動|整列|し|ます|。".split("|")]
        actual_vs_expect = [
