...
class KoreanTextTest(LangOpsTestCase):
    ...
    def test_korean(self) -> None:
        ...
        expected_character_tokens = [*"질|문|이|나| |건|의|사|항|은| |깃|헙| |이|슈| |트|래|커|에| |남|겨|주|세|요.| |English| |Subtitle,| |오|류|보|고|는| |실|행|환|경,| |에|러|메|세|지|와|함|께| |설|명|을| |최|대|한|상|세|히!".split("|")]
        expected_character_tokens_without_punctuation = [*"질|문|이|나| |건|의|사|항|은| |깃|헙| |이|슈| |트|래|커|에| |남|겨|주|세|요|.| |English| |Subtitle|,| |오|류|보|고|는| |실|행|환|경|,| |에|러|메|세|지|와|함|께| |설|명|을| |최|대|한|상|세|히|!".split("|")]
        expected_word_tokens = ["질문", "이나", " ", "건의", "사항", "은", " ", "깃헙", " ", "이슈", " ", "트래커", "에", " ", "남기", "어", "주", "세요.", " ", "English", " ", "Subtitle,", " ", "오류", "보고", "는", " ", "실행", "환경,", " ", "에러", "메세지", "와", "함께", " ", "설명", "을", " ", "최대한", "상세히!"]
        expected_word_tokens_without_punctuation = [*"질문|이나| |건의|사항|은| |깃헙| |이슈| |트래커|에| |남기|어|주|세요|.| |English| |Subtitle|,| |오류|보고|는| |실행|환경|,| |에러|메세지|와|함께| |설명|을| |최대한|상세히|!".split("|")]
        actual_vs_expect = [
