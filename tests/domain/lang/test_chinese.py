...
class ChineseTextTest(LangOpsTestCase):
    ...
    def test_chinese(self) -> None:
        ...
        self.assert_actual_vs_expect(
            [
                [o.split(text2), [*"[旁白]：|突然|天边|飘来|了|一朵|乌云，|那|乌云|之中|...|他|说：|“突然|天边|飘来|了|一朵|乌云，|那|乌云|之中|...”|《三体》|很|好看。|“AI”|上线|了！|（测试）|…|…|开始|这是|English|subtitle，|你|知道|吗？".split("|")]],
                [o.split(text2, mode="character"), [*"[旁|白]：|突|然|天|边|飘|来|了|一|朵|乌|云，|那|乌|云|之|中...|他|说：|“突|然|天|边|飘|来|了|一|朵|乌|云，|那|乌|云|之|中...”|《三|体》|很|好|看。|“AI”|上|线|了！|（测|试）|…|…|开|始|这|是|English|subtitle，|你|知|道|吗？".split("|")]],
                [o.split(text2, attach_punctuation=False), [*"[|旁白|]|：|突然|天边|飘来|了|一朵|乌云|，|那|乌云|之中|...|他|说|：|“|突然|天边|飘来|了|一朵|乌云|，|那|乌云|之中|...|”|《|三体|》|很|好看|。|“|AI|”|上线|了|！|（|测试|）|…|…|开始|这是|English|subtitle|，|你|知道|吗|？".split("|")]],
                [
                    o.split(text2, mode="character", attach_punctuation=False),
                    [*"[|旁|白|]|：|突|然|天|边|飘|来|了|一|朵|乌|云|，|那|乌|云|之|中|...|他|说|：|“|突|然|天|边|飘|来|了|一|朵|乌|云|，|那|乌|云|之|中|...|”|《|三|体|》|很|好|看|。|“|AI|”|上|线|了|！|（|测|试|）|…|…|开|始|这|是|English|subtitle|，|你|知|道|吗|？".split("|")],
                ],
                [o.split(text2, mode="word"), [*"[旁白]：|突然|天边|飘来|了|一朵|乌云，|那|乌云|之中|...|他|说：|“突然|天边|飘来|了|一朵|乌云，|那|乌云|之中|...”|《三体》|很|好看。|“AI”|上线|了！|（测试）|…|…|开始|这是|English|subtitle，|你|知道|吗？".split("|")]],
                [o.split(text2, mode="word", attach_punctuation=False), [*"[|旁白|]|：|突然|天边|飘来|了|一朵|乌云|，|那|乌云|之中|...|他|说|：|“|突然|天边|飘来|了|一朵|乌云|，|那|乌云|之中|...|”|《|三体|》|很|好看|。|“|AI|”|上线|了|！|（|测试|）|…|…|开始|这是|English|subtitle|，|你|知道|吗|？".split("|")]],
                [o.length(text2), 97],
