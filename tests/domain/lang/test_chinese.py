    ...
    def test_chinese(self) -> None:
        ...
        self.assert_actual_vs_expect(
            [
                ...
                [
                    o.split(text1, attach_punctuation=False),
                    [
                        "今天",
                        "AI",
                        "Deep",
                ...
                [
                    o.split(text1, mode="character", attach_punctuation=False),
                    [
                        "今",
                        "天",
                        "AI",
                ...
                [
                    o.split(text1, mode="word", attach_punctuation=False),
                    [
                        "今天",
                        "AI",
                        "Deep",
        ...
        self.assert_actual_vs_expect(
            [
                ...
                [
                    o.split(text2, attach_punctuation=False),
                    [
                        "[",
                        "旁白",
                        "]",
                ...
                [
                    o.split(text2, mode="word", attach_punctuation=False),
                    [
                        "[",
                        "旁白",
                        "]",
